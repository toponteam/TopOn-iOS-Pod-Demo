...
- (void)showAdButtonClickAction {
    ...
    //查询可用于展示的广告缓存(可选接入)
    //[AdCheckTool getValidAdsForPlacementID:RewardedPlacementID adType:AdTypeRewardVideo];
    
    //查询广告加载状态(可选接入)
    //[AdCheckTool adLoadingStatusWithPlacementID:RewardedPlacementID adType:AdTypeRewardVideo];
