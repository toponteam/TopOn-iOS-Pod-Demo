...
Pod::Spec.new do |s|
 ...
 # s.static_framework = true
  ...
  s.subspec 'core' do |ss|
    ...
    ss.vendored_frameworks = 'Core/AnyThinkRewardedVideo.framework','Core/AnyThinkNative.framework','Core/AnyThinkInterstitial.framework','Core/AnyThinkBanner.framework','Core/AnyThinkSplash.framework','Core/AnyThinkSDK.framework'
  ...
  s.subspec 'admob' do |ss|
    ss.ios.deployment_target = '10.0'
    ss.vendored_frameworks = 'admob/GoogleAppMeasurement.framework','admob/GoogleAppMeasurementIdentitySupport.framework','admob/GoogleMobileAds.framework','admob/GoogleUtilities.framework','admob/nanopb.framework','admob/PromisesObjC.framework','admob/UserMessagingPlatform.framework','admob/AnyThinkAdmobAdapter.framework'
  end
  ...
  s.subspec 'nend' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks = 'nend/NendAd.embeddedframework/NendAd.framework','nend/AnyThinkNendAdapter.framework'
  end
  ...
  s.subspec 'pangle_noChina' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks = 'pangle_nonChina/BUVAAuxiliary.framework','pangle_nonChina/AnyThinkPangleAdapter.framework'
  end
  
  s.subspec 'pangle_china_common' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks = 'pangle_China/BUAdSDK.framework','pangle_China/BUFoundation.framework','pangle_China/BURelyFoundation.framework'
  ...
  s.subspec 'fyber' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks = 'fyber/IASDKCore.framework','fyber/AnyThinkFyberAdapter.framework'
    
    ss.source_files  = "fyber/SwiftIntegration/*.h"
    ss.resource = 'fyber/IASDKResources.bundle'
  ...
  s.subspec 'klevin' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks =
     'klevin/KlevinAdSDK.framework','klevin/AnyThinkKlevinAdapter.framework'
 end

  s.subspec 'mobrain' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks =
     'mobrain/ABUAdSDK.framework','mobrain/ABUAdSDKAdapter.framework'
 end  

 # 4.7.2.0.0
  s.subspec 'AppLovinMediationAdColonyAdapter' do |ss|
    ss.ios.deployment_target = '9.0'
    ss.vendored_frameworks = 'AppLovinMediationAdapter/AppLovinMediationAdColonyAdapter/AppLovinMediationAdColonyAdapter.framework'
    ss.dependency 'LocalThirdPartySDK/adcolony'
  end
  
  # 8.5.0.0
  s.subspec 'AppLovinMediationChartboostAdapter' do |ss|
     ss.ios.deployment_target = '9.0'
     ss.vendored_frameworks = 'AppLovinMediationAdapter/AppLovinMediationChartboostAdapter/AppLovinMediationChartboostAdapter.framework'
     ss.dependency 'LocalThirdPartySDK/chartboost'
   end
  
  # 12.8.1.0
  s.subspec 'AppLovinMediationTapjoyAdapter' do |ss|
     ss.ios.deployment_target = '9.0'
     ss.vendored_frameworks = 'AppLovinMediationAdapter/AppLovinMediationTapjoyAdapter/AppLovinMediationTapjoyAdapter.framework'
     ss.dependency 'LocalThirdPartySDK/tapjoy'
   end
